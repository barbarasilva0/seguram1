...
<head>
    ...
    <title>Histórico - SeguraMenteKIDS</title>
        ...
        <div class="content">
            ...
            <div class="header">
                ...
                <a href="perfil.php" class="profile">
                    ...
                    <span><?php echo htmlspecialchars($nomeUsuario, ENT_QUOTES, 'UTF-8'); ?></span>
                </a>
            </div>
                ...
                <div class="quiz-header">
                    <div class="user-info">
                        ...
                        <div class="user-details">
                            <span class="user-name"><?php echo htmlspecialchars($nomeUsuario, ENT_QUOTES, 'UTF-8'); ?></span>
